...
/**
 * ServiceData.php
 * Khadomeh Service Data Transfer Object (DTO)
 */
...
class ServiceData
{
    ...
    public readonly string $short_name_ar;
    ...
    public function __construct(array $data)
    {
        ...
        $this->short_name_ar = isset($data['short_name_ar']) ? trim((string)$data['short_name_ar']) : '';
        $this->description_ar = isset($data['description_ar']) && trim($data['description_ar']) !== '' ? trim((string)$data['description_ar']) : null;
        $this->icon = isset($data['icon']) && trim($data['icon']) !== '' ? trim((string)$data['icon']) : null;
