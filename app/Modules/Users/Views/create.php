...
/**
 * create.php
 * Users Module Admin Create View
 */
?>

<div class="section-header">
    <h1 class="section-title">إضافة مستخدم جديد</h1>
    ...
    <form action="<?= url('admin/users') ?>" method="POST">
        ...
        <div class="card-body" style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
            ...
            <div class="form-group" style="grid-column: 1 / 3;">
                ...
                <input type="text" id="display_name" name="display_name" value="<?= e($old['display_name'] ?? '') ?>" class="form-control" placeholder="مثال: أحمد المحمد" required>
            ...
            <div class="form-group" style="grid-column: 1 / 2;">
                ...
                <input type="email" id="email" name="email" value="<?= e($old['email'] ?? '') ?>" class="form-control" placeholder="example@domain.com">
            ...
            <div class="form-group" style="grid-column: 2 / 3;">
                ...
                <input type="text" id="phone" name="phone" value="<?= e($old['phone'] ?? '') ?>" class="form-control" placeholder="09xxxxxxxx">
            ...
            <div class="form-group" style="grid-column: 2 / 3;">
                ...
                <select id="area_id" name="area_id" class="form-control">
                    ...
                    <?php foreach ($areas as $area): ?>
                        <option value="<?= $area['id'] ?>" data-city="<?= $area['city_id'] ?>" <?= ($old['area_id'] ?? '') == $area['id'] ? 'selected' : '' ?>><?= e($area['display_name_ar']) ?></option>
                    <?php endforeach; ?>
                </select>
            ...
            <div class="form-group" style="grid-column: 1 / 3;">
                ...
                <textarea id="default_address" name="default_address" rows="3" class="form-control" placeholder="الحي، الشارع، البناء..."><?= e($old['default_address'] ?? '') ?></textarea>
            ...
            <div class="form-group" style="grid-column: 1 / 2;">
                ...
                <select id="preferred_contact_method" name="preferred_contact_method" class="form-control">
                    <option value="phone" <?= ($old['preferred_contact_method'] ?? 'phone') === 'phone' ? 'selected' : '' ?>>الهاتف</option>
                    <option value="email" <?= ($old['preferred_contact_method'] ?? '') === 'email' ? 'selected' : '' ?>>البريد الإلكتروني</option>
                </select>
            </div>
            ...
            <div class="form-group" style="grid-column: 2 / 3;">
                ...
                <select id="preferred_language" name="preferred_language" class="form-control">
                    <option value="ar" <?= ($old['preferred_language'] ?? 'ar') === 'ar' ? 'selected' : '' ?>>العربية</option>
            ...
            <div class="form-group" style="grid-column: 1 / 2;">
                ...
                <select id="timezone" name="timezone" class="form-control">
                    <option value="Asia/Damascus" <?= ($old['timezone'] ?? 'Asia/Damascus') === 'Asia/Damascus' ? 'selected' : '' ?>>دمشق (UTC+3)</option>
                    <option value="Asia/Riyadh" <?= ($old['timezone'] ?? '') === 'Asia/Riyadh' ? 'selected' : '' ?>>الرياض (UTC+3)</option>
                    <option value="UTC" <?= ($old['timezone'] ?? '') === 'UTC' ? 'selected' : '' ?>>التوقيت العالمي (UTC)</option>
                </select>
            </div>
            ...
            <div class="form-group" style="grid-column: 1 / 3; display: flex; align-items: center; gap: 8px; margin-top: 10px;">
                <input type="checkbox" id="marketing_opt_in" name="marketing_opt_in" value="1" <?= (!isset($old['marketing_opt_in']) || $old['marketing_opt_in']) ? 'checked' : '' ?> style="width: 18px; height: 18px;">
        ...
        <div class="card-footer">
            ...
            <button type="submit" class="btn btn-primary">حفظ وإضافة المستخدم</button>
        </div>
    </form>
</div>
