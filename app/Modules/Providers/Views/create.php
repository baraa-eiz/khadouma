...
/**
 * create.php
 * Providers Module Admin Create View
 */
?>

<div class="section-header">
    <h1 class="section-title">إضافة مزود خدمة جديد</h1>
    ...
    <form action="<?= url('admin/providers') ?>" method="POST" enctype="multipart/form-data">
        ...
        <div class="card-body" style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
            ...
            <div class="form-group" style="grid-column: 1 / 2;">
                ...
                <span class="form-hint">صورة مربعة واضحة للملف الشخصي (شخصية أو شعار شركة).</span>
            ...
            <div class="form-group" style="grid-column: 2 / 3;">
                ...
                <span class="form-hint">يمكنك اختيار صور متعددة توثق أعمال سابقة ونماذج تنفيذية.</span>
            ...
            <div class="form-group" style="grid-column: 1 / 2;">
                ...
                <select id="status" name="status" class="form-control">
                    ...
                    <option value="approved" <?= ($old['status'] ?? 'approved') === 'approved' ? 'selected' : '' ?>>مقبول ومعتمد (نشط)</option>
        ...
        <div class="card-footer">
            ...
            <button type="submit" class="btn btn-primary">حفظ وإضافة مزود الخدمة</button>
        </div>
    </form>
</div>
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        // Bind events
        citySelect.addEventListener('change', filterAreasByCity);
