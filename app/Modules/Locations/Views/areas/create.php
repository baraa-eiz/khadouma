...
/**
 * create.php
 * Areas Module Admin Create View
 */
?>

<div class="section-header">
    <h1 class="section-title">إضافة منطقة جديدة</h1>
...
<div class="card" style="max-width: 800px; margin: 0 auto;">
    <form action="<?= url('admin/areas') ?>" method="POST">
        ...
        <div class="card-body" style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
            ...
            <div class="form-group" style="grid-column: 1 / 3;">
                <label class="form-label" for="city_id">المدينة التابعة لها <span style="color: var(--danger);">*</span></label>
                <select id="city_id" name="city_id" class="form-control" required>
                    <option value="">-- اختر المدينة --</option>
                    <?php foreach ($cities as $city): ?>
                        <option value="<?= $city['id'] ?>" <?= ($old['city_id'] ?? '') == $city['id'] ? 'selected' : '' ?>><?= e($city['display_name_ar']) ?></option>
                    <?php endforeach; ?>
                </select>
            ...
            <div class="form-group" style="grid-column: 1 / 2;">
                ...
                <input type="text" id="key" name="key" value="<?= e($old['key'] ?? '') ?>" class="form-control" style="font-family: monospace;" placeholder="e.g. mezzeh" required>
            ...
            <div class="form-group" style="grid-column: 2 / 3;">
                ...
                <input type="text" id="slug" name="slug" value="<?= e($old['slug'] ?? '') ?>" class="form-control" style="font-family: monospace;" placeholder="e.g. mezzeh">
            ...
            <!-- Display Name Arabic -->
            <div class="form-group" style="grid-column: 1 / 2;">
                <label class="form-label" for="display_name_ar">اسم المنطقة الكامل (بالعربية) <span style="color: var(--danger);">*</span></label>
                <input type="text" id="display_name_ar" name="display_name_ar" value="<?= e($old['display_name_ar'] ?? '') ?>" class="form-control" placeholder="مثال: المزة" required>
            ...
            <div class="form-group" style="grid-column: 2 / 3;">
                ...
                <input type="text" id="display_name_en" name="display_name_en" value="<?= e($old['display_name_en'] ?? '') ?>" class="form-control" placeholder="مثال: Mezzeh">
            ...
            <div class="form-group" style="grid-column: 1 / 3;">
                ...
                <input type="text" id="meta_title_ar" name="meta_title_ar" value="<?= e($old['meta_title_ar'] ?? '') ?>" class="form-control" placeholder="مثال: أفضل الخدمات المنزلية في المزة، دمشق | منصة خدومة">
            ...
            <div class="form-group" style="grid-column: 1 / 3;">
                ...
                <textarea id="meta_description_ar" name="meta_description_ar" class="form-control" rows="3" placeholder="مثال: اعثر على أفضل الفنيين والخدمات في منطقة المزة بدمشق..."><?= e($old['meta_description_ar'] ?? '') ?></textarea>
            ...
            <div class="form-group" style="grid-column: 1 / 3; display: flex; flex-direction: row; align-items: center; justify-content: space-between; background-color: var(--bg-hover); padding: 12px 16px; border-radius: var(--radius-sm); margin-top: 8px;">
                <div>
                    <label class="form-label" style="margin-bottom: 2px;">تفعيل المنطقة</label>
                    <span style="font-size: 12px; color: var(--text-muted);">تحديد ما إذا كانت المنطقة تظهر في الواجهة العامة للموقع.</span>
                </div>
        ...
        <div class="card-footer">
            <a href="<?= url('admin/areas') ?>" class="btn btn-secondary">إلغاء</a>
            <button type="submit" class="btn btn-primary">حفظ وإضافة المنطقة</button>
        </div>
    </form>
</div>
