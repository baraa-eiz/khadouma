...
/**
 * edit.php
 * Areas Module Admin Edit View
 */
?>

<div class="section-header">
    <h1 class="section-title">تعديل المنطقة: <?= e($item['display_name_ar']) ?></h1>
...
<div class="card" style="max-width: 800px; margin: 0 auto;">
    <form action="<?= url('admin/areas/' . $item['id'] . '/update') ?>" method="POST">
        ...
        <div class="card-body" style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
            ...
            <div class="form-group" style="grid-column: 1 / 2;">
                ...
                <input type="text" id="key" name="key" value="<?= e($old['key'] ?? '') ?>" class="form-control" style="font-family: monospace;" required>
            ...
            <div class="form-group" style="grid-column: 2 / 3;">
                ...
                <input type="text" id="slug" name="slug" value="<?= e($old['slug'] ?? '') ?>" class="form-control" style="font-family: monospace;">
                <span class="form-hint">أحرف صغيرة وشرطات فقط.</span>
            ...
            <div class="form-group" style="grid-column: 1 / 2;">
                ...
                <input type="text" id="display_name_ar" name="display_name_ar" value="<?= e($old['display_name_ar'] ?? '') ?>" class="form-control" required>
            ...
            <div class="form-group" style="grid-column: 2 / 3;">
                ...
                <input type="text" id="display_name_en" name="display_name_en" value="<?= e($old['display_name_en'] ?? '') ?>" class="form-control">
            ...
            <div class="form-group" style="grid-column: 1 / 3;">
                ...
                <input type="number" id="sort_order" name="sort_order" value="<?= e($old['sort_order'] ?? '0') ?>" class="form-control" min="0">
            ...
            <div class="form-group" style="grid-column: 1 / 3;">
                ...
                <input type="text" id="meta_title_ar" name="meta_title_ar" value="<?= e($old['meta_title_ar'] ?? '') ?>" class="form-control">
            ...
            <div class="form-group" style="grid-column: 1 / 3;">
                ...
                <textarea id="meta_description_ar" name="meta_description_ar" class="form-control" rows="3"><?= e($old['meta_description_ar'] ?? '') ?></textarea>
