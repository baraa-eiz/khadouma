...
<div class="table-container">
    <?php if (empty($items)): ?>
        <?php 
        $empty_title = 'لا توجد مدن مطابقة';
        $empty_desc = 'لم نعثر على أي مدن تطابق معايير البحث الحالية.';
        $empty_action_url = url('admin/cities/create');
        $empty_action_label = 'إضافة مدينة جديدة';
