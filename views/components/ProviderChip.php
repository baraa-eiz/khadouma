...
?>
<?php if ($isSelf): ?>
<span class="provider-chip <?= e($class) ?>" style="display: inline-flex; align-items: center; gap: 6px; background-color: #ffffff; color: var(--text-primary); border: 1px solid var(--border-color); padding: 5px 12px; border-radius: 8px; font-size: 0.85rem; font-weight: 700; cursor: default; box-shadow: 0 1px 2px 0 rgba(0, 0, 0, 0.05); <?= e($style) ?>">
    👤 <?= e($name) ?>
    <?php if ($verified): ?>
